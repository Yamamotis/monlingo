...
const FEATURES = [
  ...
  { icon: '🎧', title: 'Áudio nativo',        sub: 'Voz francesa real em cada exercício' },
  { icon: '🔥', title: 'Gamificação',         sub: 'Streaks, XP e conquistas' },
  { icon: '📱', title: 'Mobile-first',        sub: 'Funciona em qualquer dispositivo' },
]
    ...
    <div className="landing-screen">
      <div className="landing-hero">
        ...
        <button className="btn-google btn-google-landing" onClick={handleGoogle} disabled={loading}>
          ...
          {loading ? 'Entrando…' : 'Começar de graça com Google'}
        </button>
      ...
      <div className="landing-levels">
        <p className="landing-levels-title">O que você vai aprender</p>
